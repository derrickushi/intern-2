  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center pb-10">
        <Head>
          <title>Next.js Store - Cart</title>
          <meta name="description" content={`Next.js Store - Shopping cart`} />
          <meta property="og:title" content="Next.js Store - Cart" key="title" />
        </Head>
        <div className="
                      ...
                      return (
                        <div className="border-b py-10" key={item.id}>
                          <div className="flex items-center hidden md:flex">
                            <Link href={`/product/${slugify(item.title)}`}>
