  ...
  return (
    <>
      <div className="w-full">
        <CartLink />
        <Head>
          <title>Next.js Store - All Categories</title>
          <meta name="description" content={`Next.js Store - All categories`} />
          <meta property="og:title" content="Next.js Store - All Categories" key="title" />
        </Head>
        <div className="
          pt-4 sm:pt-10 pb-8
        ">
